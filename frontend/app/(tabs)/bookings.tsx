...
const styles = StyleSheet.create({
  ...
  bookingCard: { flexDirection: 'row', backgroundColor: Colors.bg.card, borderRadius: 12, borderWidth: 1, borderColor: Colors.border.default, padding: 12, marginBottom: 10, gap: 10 },
  ...
  bookingActions: { alignItems: 'flex-end', gap: 6, justifyContent: 'center' },
  activeBadge: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 6, borderWidth: 1, borderColor: Colors.status.success },
  activeBadgeText: { fontFamily: Fonts.body, fontSize: 11, color: Colors.status.success },
  cancelSmallBtn: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 6, borderWidth: 1, borderColor: Colors.status.danger },
  cancelSmallText: { fontFamily: Fonts.body, fontSize: 11, color: Colors.status.danger },
  ...
  emptySection: { paddingVertical: 30, alignItems: 'center' },
